...
public class PostDetailActivity extends AppCompatActivity implements CommentAdapter.OnCommentActionListener {
    ...
    private void setupCommentListener() {
        ...
        commentListener = db.collection("forum_posts").document(postId)
                ...
                .addSnapshotListener((value, error) -> {
                    showLoading(false);
                    if (error != null) {
                        Log.e(TAG, "Cannot set listener", error);
                        showError("Cannot load comments");
                        return;
                    }
                    if (value != null) {
    ...
    private void addComment(String commentText) {
        ...
        db.collection("forum_posts").document(postId)
                ...
                .addOnFailureListener(e -> {
                    ...
                    showError("Cannot add comment: " + e.getMessage());
                });
    }
    ...
    private void handleLike() {
        ...
        db.collection("forum_posts").document(postId)
                ...
                .addOnSuccessListener(documentSnapshot -> {
                    if (documentSnapshot.exists()) {
                        boolean isLiked = Boolean.TRUE.equals(documentSnapshot.getBoolean("hasLiked"));
                    ...
                    .setPositiveButton("delete", (dialog, which) -> {
                        ...
                        db.collection("forum_posts").document(postId)
                                ...
                                .addOnFailureListener(e -> {
                                    ...
                                    showError("Cannot delete comment: " + e.getMessage());
                                });
                    })
